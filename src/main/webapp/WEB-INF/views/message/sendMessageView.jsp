...
<body>
    <div class="wrap row">
        ...
        <div class="col-12">
            <div class="row">
              <div class="col-2 col-md-2 col-xl-1 title2">받은이</div>
              <div class="col-3 col-md-4 col-xl-5 verticalLine">${viewmessage.msg_reciever}</div>
              <div class="col-3 col-md-2 col-xl-1 title2">작성 일</div>
        ...
        <button id="send" class="btn btn-outline-info btn-sm">돌아 가기</button>
        </div>
    </div>
    <script> 
