...
<body>
					...
					<div class="col-12 col-md-10 d-none d-xl-block">
						<nav class="site-navigation position-relative text-right"
							...
							<ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
								...
								<li class="active"><a href="#"><span>AboutUs</span></a>
								</li>
	...
	<div class="site-blocks-cover overlay"
		style="background-image: url(/resources/images/dog.jpg);" data-aos="fade"
		...
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center border-primary">
					<h2 class="font-weight-light text-info">Popular Categories</h2>
					<p class="color-black-opacity-5">Far far away, behind the word
			...
			<div class="row align-items-stretch">
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-hotel"></span></span> <span
						class="caption mb-2 d-block">Hotels</span>

					</a>
				</div>
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-microphone"></span></span>
						<span class="caption mb-2 d-block">Events</span>
					</a>
				</div>
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-flower"></span></span> <span
						class="caption mb-2 d-block">Spa</span>
					</a>
				</div>
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-restaurant"></span></span>
						<span class="caption mb-2 d-block">Stores</span>
					</a>
				</div>
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-cutlery"></span></span> <span
						class="caption mb-2 d-block">Restaurants</span>
					</a>
				</div>
				<div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
					<a href="#" class="popular-category h-100"> <span
						class="icon mb-3"><span class="flaticon-bike"></span></span> <span
						class="caption mb-2 d-block">Other</span>
					</a>
				</div>
			</div>
			...
			<div class="row mt-5 justify-content-center tex-center">
				<div class="col-md-4">
					<a href="#" class="btn btn-block btn-outline-info btn-md px-5">View
						All Categories</a>
				</div>
			</div>
		</div>
	...
	<div class="site-section" data-aos="fade">
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center border-primary">
					<h2 class="font-weight-light text-info">Most Visited Places</h2>
					<p class="color-black-opacity-5">Far far away, behind the word
						mountains, far from the countries Vokalia and Consonantia, there
						live the blind texts.</p>
				</div>
			...
			<div class="row">
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/cat12.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>

						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"
								data-toggle="tooltip" data-placement="left" title="Bookmark"><span
								class="icon-heart"></span></a> <a class="px-3 mb-3 category"
								href="#">Hotels</a>
							<h2 class="mb-1">
								<a href="listings-single.html">Cat Hotel</a>
							</h2>
							<span class="address">고양이 커뮤니티</span>
						</div>
					</div>
				...
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/catto.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>
						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"><span
								class="icon-heart"></span></a> <a class="px-3 mb-3 category"
								href="#">Restaurants</a>
							<h2 class="mb-1">
								<a href="listings-single.html">Jones Grill &amp; Restaurants</a>
							</h2>
				...
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/catcc.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>
						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"><span
								...
								href="#">Events</a>
							<h2 class="mb-1">
								<a href="listings-single.html">Live Band</a>
							</h2>
				...
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/dog11.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>
						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"
								...
								href="#">Others</a>
							<h2 class="mb-1">
								<a href="listings-single.html">Gourmet Coffees</a>
							</h2>
				...
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/well.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>
						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"><span
								...
								href="#">Spa</a>
							<h2 class="mb-1">
								<a href="listings-single.html">La Italia Spa</a>
							</h2>
				...
				<div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
					...
					<div class="listing-item">
						<div class="listing-image">
							<img src="resources/images/dogr.jpg"
								alt="Free Website Template by Free-Template.co"
								class="img-fluid" style="height: 283.38px;">
						</div>
						<div class="listing-item-content">
							<a href="listings-single.html" class="bookmark"><span
								...
								href="#">Stores</a>
							<h2 class="mb-1">
								<a href="listings-single.html">Super Market Mall</a>
							</h2>
							<span class="address">West Orange, New York</span>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 ml-auto">
					<h2 class="text-info mb-3">HOW USE</h2>
					<div class="row mt-4">
						<div class="col-12">
							<div class="border p-3 rounded mb-2">
								<a data-toggle="collapse" href="#collapse-1" role="button"
									aria-expanded="false" aria-controls="collapse-1"
									class="accordion-item h5 d-block mb-0">어떤 사이트 인가요?</a>

								<div class="collapse" id="collapse-1">
									<div class="pt-2">
										<p class="mb-0">저희 사이트는 현대에 바쁜사람들에 맞추어 펫을 케어해주는 웹사이트 입니다</p>
									</div>
								</div>
							</div>

							<div class="border p-3 rounded mb-2">
								<a data-toggle="collapse" href="#collapse-4" role="button"
									aria-expanded="false" aria-controls="collapse-4"
									class="accordion-item h5 d-block mb-0">어떤 서비스를 이용할 수 있나요</a>

								<div class="collapse" id="collapse-4">
									<div class="pt-2">
										<p class="mb-0">저희 페이지를 이용하여 가능한 스케줄에 신청을 하시면 그에 맞춰 펫시터가
											방문하여 펫케어를 해줍니다</p>
									</div>
								</div>
							</div>
							...
							<div class="border p-3 rounded mb-2">
								<a data-toggle="collapse" href="#collapse-2" role="button"
									aria-expanded="false" aria-controls="collapse-2"
									class="accordion-item h5 d-block mb-0">강아지가 외부인을 싫어 하면 어떡하죠</a>

								<div class="collapse" id="collapse-2">
									<div class="pt-2">
										<p class="mb-0">괜찬아요 내가 가는거 아니니까</p>
									</div>
								</div>
							</div>

							<div class="border p-3 rounded mb-2">
								<a data-toggle="collapse" href="#collapse-3" role="button"
									aria-expanded="false" aria-controls="collapse-3"
									class="accordion-item h5 d-block mb-0">산책은 시켜주나요</a>

								<div class="collapse" id="collapse-3">
									<div class="pt-2">
										<p class="mb-0">신청란에 적어주시면 산책을 펫시터가 해줍니다</p>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="site-section">
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center border-primary">
					<h2 class="font-weight-light text-info">How It Works</h2>
					<p class="color-black-opacity-5">Far far away, behind the word
						mountains, far from the countries Vokalia and Consonantia, there
						live the blind texts.</p>
				</div>
			...
			<div class="row">
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
					<div class="how-it-work-step">
						<div class="img-wrap">
							<img src="resources/images/step-1.svg"
								alt="Free website template by Free-Template.co"
								class="img-fluid">
						</div>
				...
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
					<div class="how-it-work-step">
						<div class="img-wrap">
							<img src="resources/images/step-2.svg"
								alt="Free website template by Free-Template.co"
								class="img-fluid">
						</div>
				...
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-4">
					<div class="how-it-work-step">
						<div class="img-wrap">
							<img src="resources/images/step-3.svg"
								alt="Free website template by Free-Template.co"
								class="img-fluid">
						</div>
			...
			<div class="slide-one-item home-slider owl-carousel">
				...
				<div>
					<div class="testimonial">
						...
						<blockquote>
							<p>&ldquo;저는 고양이를 키우고 있는데 예민해서 스트레스 받을 줄 알았는데 섬세한 부분까지 신경써주셔서
								저희 냐옹이가 저보다 펫시터님을 더 좋아해요 &rdquo;</p>
						</blockquote>
					</div>
				</div>
	...
	<div class="site-section">
		<div class="container">
			<div class="row justify-content-center mb-5">
				<div class="col-md-7 text-center border-primary">
					<h2 class="font-weight-light text-info">Tips &amp; Articles</h2>
					<p class="color-black-opacity-5">See Our Daily tips &amp;
						articles</p>
				</div>
			</div>
				...
				<div class="col-md-9">
					<div class="row">
						...
						<div class="col-md-6 mb-5 mb-lg-0 col-lg-3">
							...
							<a href="https://ko-kr.facebook.com/login" class="pl-0 pr-3"><span
								class="icon-facebook"></span></a> <a href="#" class="pl-3 pr-3"><span
								class="icon-twitter"></span></a> <a href="#" class="pl-3 pr-3"><span
								class="icon-instagram"></span></a> <a href="#" class="pl-3 pr-3"><span
