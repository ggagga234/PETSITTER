      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-white h2 mb-0">펫시터</a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="about.html"><span>펫시터찾기</span></a></li>
                <li><a href="listings.html"><span>펫시터구인</span></a></li>
                <li><a href="about.html"><span>커뮤니티</span></a></li>
                <li><span><a href="#">JOIN</a><a href="#">/LOGIN</a></span></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                <h1 data-aos="fade-up">PETSITER LIFE <span class="typed-words"></span></h1>
                <p data-aos="fade-up" data-aos-delay="100">Free Pet World by <a href="https://free-template.co/" target="_blank">Animal</a></p>
              </div>
            </div>

            <div>
              <form method="post">
                    <input type="submit" class="btn text-white btn-primary" value="펫시터 찾기">
              </form>
             </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary">인기있는 펫시터</h2>
            <p class="color-black-opacity-5">Popular Pet dog manager</p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              ...
              <div class="listing-item-content">
                <h2 class="mb-1 text-primary">1위</h2>
                <span class="address">안진주 펫시터</span>
                <p>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              ...
              <div class="listing-item-content">
                <h2 class="mb-1">2위</h2>
                <span class="address">Brookly</span>
                <p>
					<span class="icon-star text-warning"></span>
					<span class="icon-star text-warning"></span>
					<span class="icon-star text-warning"></span>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              ...
              <div class="listing-item-content">
                <h2 class="mb-1">3위</h2>
                <span class="address">West Orange</span>
                <p>
					<span class="icon-star text-warning"></span>
					<span class="icon-star text-warning"></span>
					<span class="icon-star text-warning"></span>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              <div class="listing-image">
                <img src="resources/images/img_4.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
              </div>
              <div class="listing-item-content">
                <h2 class="mb-1">4위</h2>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              <div class="listing-image">
                <img src="resources/images/img_5.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
              </div>
              <div class="listing-item-content">
                <h2 class="mb-1">5위</h2>
          ...
          <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
            ...
            <div class="listing-item">
              <div class="listing-image">
                <img src="resources/images/img_6.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
              </div>
              <div class="listing-item-content">
                <h2 class="mb-1">6위</h2>
                <span class="address">West Orange</span>
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="resources/images/person_3_sq.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid mb-3">
                <p>Willie Smith</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="resources/images/person_2_sq.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid mb-3">
                <p>Robert Jones</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="resources/images/person_4_sq.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid mb-3">
                <p>Peter Richmond</p>
              </figure>
              <blockquote>
